...
- The Wiki-API contains 5 RESTful API, GET, POST, PATCH, DELETE which is the request body sent by client to do opreations to article document in database and then server will sent back the result through API to client.
## RESTful API
